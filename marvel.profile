 ...
 *
 */
function marvel_install_tasks_alter(&$tasks, $install_state) {
  // Callback for languageg selection.
  $tasks['install_select_locale']['function'] = 'marvel_locale_selection';
}

// Set default language to english.
function marvel_locale_selection(&$install_state) {
 ...
 */
function marvel_install_tasks(&$install_state) {
  $ret = array(
    // Update translations.
    'marvel_import_translation' => array(
 ...
 *   List of batches.
 */
function marvel_import_translation(&$install_state) {
